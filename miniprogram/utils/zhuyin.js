...
const ZM_SYMBOLS = 'ㄅㄆㄇㄈㄉㄊㄋㄌㄍㄎㄏㄐㄑㄒㄓㄔㄕㄖㄗㄘㄙㄧㄨㄩㄚㄛㄜㄝㄞㄟㄠㄡㄢㄣㄤㄥㄦ';
const ZM_KEYS = '1qaz2wsxedcrfv5tgbyhnujm8ik,9ol.0p;/-';

const KEY_OF_ZM = Object.fromEntries([...ZM_SYMBOLS].map((s, i) => [s, ZM_KEYS[i]]));
const ZM_OF_KEY = Object.fromEntries([...ZM_SYMBOLS].map((s, i) => [ZM_KEYS[i], s]));

// ---- 声调键与调号 ----
const TONE_KEYS = { 1: ' ', 2: '6', 3: '3', 4: '4', 5: '7' }; // ˉ=空格（〔规格推断〕4）
const TONE_MARKS = { 1: 'ˉ', 2: 'ˊ', 3: 'ˇ', 4: 'ˋ', 5: '˙' };
const TONE_NAME = { 1: '第一声（ˉ）', 2: '第二声（ˊ）', 3: '第三声（ˇ）', 4: '第四声（ˋ）', 5: '轻声（˙）' };
...
const ZY_ROWS = ['1234567890-', 'qwertyuiop', 'asdfghjkl;', 'zxcvbnm,./'];
const ZY_EXTRA_KEYS = [' '];
...
module.exports = { ZM_SYMBOLS, ZM_KEYS, KEY_OF_ZM, ZM_OF_KEY, TONE_KEYS, TONE_MARKS, TONE_NAME, ZY_ROWS, ZY_EXTRA_KEYS, ZY_GROUPS, toZhuyin, keysOfToned, planOfToned };
