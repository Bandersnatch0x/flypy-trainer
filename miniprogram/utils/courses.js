...
const { ZY_GROUPS } = require('./zhuyin.js');
...
function challengeMatch(match, mode, course) {
...
module.exports = { COURSES, courseOf, syllablesOf, confusKeys, confusEndsMatch, stageModes, challengeMatch };
