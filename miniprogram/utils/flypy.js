...
const SM_KEYS = { zh: 'v', ch: 'i', sh: 'u' };
const SM_NAME = { v: 'zh', i: 'ch', u: 'sh' };
...
const SYLLABLES = new Set(SYL);

// 贪心最长匹配 + 回溯；失败返回 null
function splitPinyin(code) {
...
module.exports = { YM, SM_KEYS, SM_NAME, SYLLABLES, normalizeSyllable, splitSyllable, splitPinyin };
